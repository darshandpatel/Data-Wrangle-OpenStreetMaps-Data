...
def article_overview(kind, period):
    ...
    #print data
    for value in data:
        title_dic = { value['section'] : value['title']}
        titles.append(title_dic)
        for media_values in value['media']:
            for media_metadata_value in media_values['media-metadata']:
                if media_metadata_value['format'] == FORMAT:
                    urls.append(media_metadata_value['url'])
